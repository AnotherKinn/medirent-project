...
<link rel="stylesheet" href="/css/tensi.css">
  ...
  <section class="transaksi-container">
    <div class="left-side">
      ...
      <div class="image-section">
        <img src="css/asset/tensi.jpg" alt="Kursi Roda">
      </div>
    </div>

    <div class="info-section">
      <h2>Tensi Meter Digital</h2>
      <p>Tensi meter otomatis dengan layar LCD yang menampilkan hasil cepat dan akurat.Dilengkapi fitur deteksi detak jantung tidak teratur serta memori hasil pengukuran.Ringan, praktis, dan mudah digunakan di rumah atau fasilitas kesehatan.</p>
      <span class="harga">Rp. 20.000 / Hari</span>
