<x-app-layout>
    <div style="font-family:'Poppins'; background:#9db7e0; min-height:100vh; padding-bottom:60px;">
     ...
     <style>
        ...
        ">
            <h2 style="margin-bottom:20px; font-weight:600; color:#333;">Tambah Alat</h2>
            ...
            <form action="{{ route('admin.data-alat.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <textarea name="deskripsi" required
                          style="width:100%; padding:10px; margin-bottom:15px; border-radius:6px; border:1px solid #ccc;"></textarea>
                ...
                <button type="submit"
                        style="width:100%; background:#1a73e8; padding:12px; border:none;
