...
<head>
    ...
    <title>Upload Bukti Pembayaran - MediRent</title>
...
<body>
    ...
    <div class="main-content">
        <a href="{{ route('user.transaksi.index') }}" class="back-link">
        ...
        <div class="payment-container">
            <div class="order-summary">
                ...
                <div class="order-detail">
                    ...
                    <span class="detail-value">{{ $transaksi->booking->alat->nama_alat }}</span>
                </div>

                <div class="order-detail">
                    <span class="detail-label">Tanggal Sewa</span>
                    <span class="detail-value">
                        {{ \Carbon\Carbon::parse($transaksi->booking->tanggal_sewa)->format('d-m-Y') }}
                    </span>
                </div>
                 ...
                 <div class="order-detail">
                    ...
                    <span class="detail-value">
                        {{ \Carbon\Carbon::parse($transaksi->booking->tanggal_kembali)->format('d-m-Y') }}
                    </span>
                </div>
                ...
                <div class="order-detail">
                    ...
                    @if($transaksi->booking->metode_pengambilan === 'diambil')
                    <span class="detail-value">Diambil (Pick Up)</span>
                    @elseif($transaksi->booking->metode_pengambilan === 'diantar')
                    <span>Diantar</span>
                    @endif
                </div>
            </div>
            ...
            <div class="payment-form">
                ...
                <form action="{{ route('user.transaksi.uploadProses', $transaksi->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf

                    <p>Dengan ini saya menyetujui syarat dan ketentuan penyewaan alat kesehatan di MediRent, termasuk:
                    </p>

                    <div class="terms-section">
                        <div class="terms-title">Syarat & Ketentuan</div>
                        <ul class="terms-list">
                            <li class="terms-item">Keterlambatan pengembalian alat akan dikenakan denda sesuai
                                kebijakan.</li>
                            <li class="terms-item">Kerusakan atau kehilangan alat selama masa sewa menjadi tanggung
                                jawab penyewa.</li>
                    ...
                    <div class="upload-section">
                        <label for="upload_proof" class="upload-button">
                            <i class="fa-solid fa-upload"></i> Upload Bukti Pembayaran
                        </label>
                        <input type="file" id="upload_proof" class="upload-input" name="bukti_pembayaran"
        ...
        <script>
            ...
            // Handle file upload
            document.getElementById('upload_proof').addEventListener('change', function (e) {
                if (e.target.files.length > 0) {
                    const fileName = e.target.files[0].name;
                    const button = document.querySelector('.upload-button');
                    button.innerHTML = `<i class="fa-solid fa-check"></i> ${fileName}`;
                }
            });
